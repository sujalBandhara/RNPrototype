...
class HomeList extends Component {
    render() {
        ...
        let imgWidth
        if(this.props.styleImages==="single"){
            imgWidth = Dimensions.get('window').width - 50
        }else if(this.props.styleImages==="multiple"){
            imgWidth = (this.props.width) ? this.props.width : Dimensions.get('window').width / 4
        }else{
          imgWidth = (this.props.width) ? this.props.width : Dimensions.get('window').width / 4
        }
